...
class OngkirController extends Controller
{
    public function ongkir(Request $request){
        ...
        $key = '09a0405b6c05416fd21f9dd03844598b'; //Buat akun atau pakai API akun Tahu Coding
        ...
        //load view form
        return view('customer.ongkir',compact('provinces','result_cost','name','origin_name','destination_name','data_weight','data_courier'));
