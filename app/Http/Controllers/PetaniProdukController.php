...
class PetaniProdukController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        return view('petani.detailproduk', compact('produk'));
    }
    ...
    public function produk(Request $request, $id)
    {
        ...
        {
            return redirect('/petani/detailproduk/'.$id);
        }
        ...
        return redirect('/petani/check_out');
    }
    ...
    public function check_out()
    {
        ...
        return view('petani.check_out', compact('transaksi', 'transaksi_details'));
    }
    ...
    public function konfirmasi()
    {
        ...
        return redirect('/petani/history');
    }
    ...
    public function history()
    {
        ...
        return view('petani.history', compact('transaksis'));
    }
    ...
    public function historyDetail($id)
    {
        ...
        return view('petani.historyDetail', compact('transaksi', 'transaksi_details'));
    }
}
